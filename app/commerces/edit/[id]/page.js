        ...
        <>
            ...
            :
                <div className="container-fluid mt-5">
                    <h1 className="display-5 text-center">Welcome, {commerce.name}!</h1>
                    <div className="container w-50 mt-5 border rounded">
                        <div className="row p-2 align-items-center">
                            <div className="col-10">
                                <p className="m-0 fs-3">City: {commerce.city}</p>
                            </div>
                            <div className="col-2 align-items-center justify-content-center text-center">
                                <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => handleEditClick('city', commerce.city)}>Edit</button>
                            </div>
                        </div>
                        <hr className="m-0"/>
                        <div className="row p-2 align-items-center">
                            <div className="col-10">
                                <p className="m-0 fs-3">Activity: {commerce.activity}</p>
                            </div>
                            <div className="col-2 align-items-center justify-content-center text-center">
                                <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => handleEditClick('activity', commerce.activity)}>Edit</button>
                            </div>
                        </div>
                        <hr className="m-0"/>
                        <div className="row p-2 align-items-center">
                            <div className="col-10">
                                <p className="m-0 fs-3">Title: {commerce.name}</p>
                            </div>
                            <div className="col-2 align-items-center justify-content-center text-center">
                                <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => handleEditClick('name', commerce.name)}>Edit</button>
                            </div>
                        </div>
                        <hr className="m-0"/>
                        <div className="row p-2 align-items-center">
                            <div className="col-10">
                                <p className="m-0 fs-3">Summary: {commerce.summary}</p>
                            </div>
                            <div className="col-2 align-items-center justify-content-center text-center">
                                <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => handleEditClick('summary', commerce.summary)}>Edit</button>
                            </div>
                        </div>
                    </div>
                    <div className="container-fluid mt-5">
                        <h1 className="display-6 text-center">Users in {commerce.city} with {commerce.activity} interest:</h1>
                        <div className="container w-50 mt-5 border rounded">
                    ...
                    <div className="container-fluid mt-5 mx-0 text-center">
                        <button className="btn btn-danger" onClick={handleDeleteCommerce}>Delete Commerce</button>
                    </div>
